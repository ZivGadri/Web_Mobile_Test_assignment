...
public class Constants {
    ...
    public static final String AVD_NAME = "Pixel_6_Pro_API_35"; // To be updated for individual local run
    public static final String DEVICE_NAME = "emulator-5554"; // To be updated for individual local run
